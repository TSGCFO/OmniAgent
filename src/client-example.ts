...
// import { MastraClient } from "@mastra/client-js"; // Temporarily commented out - package not installed

async function clientExample() {
  console.log("🌐 Testing OmniAgent Network via Client...\n");
  console.log("⚠️ Client example temporarily disabled - @mastra/client-js not installed");
